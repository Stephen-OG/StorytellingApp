...
session_start();
      ...
      $delete_saved_stories = delete_saved_stories($con);
?>
        ...
        <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#"
            ...
            <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
                ...
                <li class="nav-item dropdown mr-3"><a id="notifications" href="http://example.com"
                    ...
                    <div aria-labelledby="notifications" class="dropdown-menu"><a href="../StoryTeller/signup.html"
                            class="dropdown-item">
			...
			<div class="row">
                        ...
                        <?php
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
                                    ...
                                    <button type=submit style="float: right;" title="Remove from saved stories"><i class="fas fa-trash"></i><a href="../delete.php?storyid=<?php echo $story_data["id"];?>"></a></button>
                                    </form>
                                </h4>
				...
				<div class="col-md-4 col-lg-3 p-b-75">
					<div class="rightbar">
                        ...
                        <!-- Recommended Books -->
                        <h4 class="m-text23 p-t-65 p-b-34" style="font-family: 'Poppins';">
                            Recommendations
                        </h4>
