<?php
      ...
      $admin_check = admin_login_check($con);
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                            ...
                            <div class="flex-grow-1 d-flex align-items-center">
                                ...
                                <div class="text" style="margin-left: 4px;">
                                <h6 class="mb-0" style="color: #212529; text-align: left; margin-left: 4px;">Pending Stories</h6><span class="text-gray" style="font-size:smaller; float: left; margin-left: 4px;"><?php echo $pending_stories?> / <?php echo $total_stories?></span>
                                </div>
                            </div>
