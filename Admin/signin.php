      ...
      <div class="container">
        <div class="row align-items-center py-5">
          <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
            <div class="pr-lg-5"><img src="../img/typing.jpg" alt="" class="img-fluid"></div>
          </div>
          <div class="col-lg-5 px-lg-4">
            <h1 class="text-base text-primary text-uppercase mb-4">Admin Sign In</h1>
            ...
            <form id="loginForm" class="mt-4" method="POST">
              ...
              <button name="adminloginbtn" type="submit" class="btn btn-primary shadow px-5">Sign in</button>
              <br>
              <br>
            </form>
