  ...
  <div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
      ...
      <ul class="sidebar-menu list-unstyled">
        ...
        <li class="sidebar-list-item"><a href="index.php#home" class="sidebar-link text-muted"><i
              class="o-home-1 mr-3 text-gray"></i><span>Home</span></a></li>
        <li class="sidebar-list-item"><a href="index.php#stories" class="sidebar-link text-muted"><i
              class="o-paper-stack-1 mr-3 text-gray"></i><span>Stories</span></a></li>
        <li class="sidebar-list-item"><a href="index.php#users" class="sidebar-link text-muted"><i
        ...
        <section class="py-5">
            ...
            <div class="row">
              ...
              <div class="col-lg-12"><a href="#" class="message card px-5 py-3 mb-4 bg-hover-gradient-primary no-anchor-style">
                  <div class="row">
                    <div class="col-lg-3 d-flex align-items-center flex-column flex-lg-row text-center text-md-left"><strong class="h5 mb-0"><sup class="smaller text-gray font-weight-normal"> 
                      <?php 
                      echo date("j M", strtotime($row['CreatedDate']));
                      ?>  </sup></strong>
                    <?php 
